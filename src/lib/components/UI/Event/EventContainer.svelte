				...
				<div class="w-full sm:w-4/5 flex flex-col m-2 sm:m-5 gap-1">
					<div class="flex flex-row">
						<div class="bg-gray-600 rounded-lg">
							<label class="text-left font-bold mx-2 text-black">
						...
						>
							<div class="text-left font-bold mx-2 text-black">{$t['events.text3']}</div>
							<div class=" flex justify-center items-center">
	...
	{:else}
		<div class="flex flex-col overflow-auto gap-1">
			<div class="flex flex-row gap-2">
				<div class="bg-gray-600 rounded-lg">
					<div class="text-left font-bold mx-2 text-black">{$t['events.text1']}</div>
				</div>
				...
				>
					<div class="text-left font-bold mx-2 text-black">{$t['events.text2']}</div>
					<div class=" flex justify-center items-center">
